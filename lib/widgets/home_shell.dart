...
class _HomeShellState extends State<HomeShell> {
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  _legendItem('🪙', 'Coins', 'Earn coins through quizzes and good health habits!'),
                  const SizedBox(height: 20),
                  ElevatedButton(
  ...
  void _showToast(BuildContext context, String message, String icon) {
    ...
    // Handle Action Challenge trigger - REMOVED (no longer part of the game)
    /*
    if (message.startsWith('ACTION_CHALLENGE::')) {
      // Action challenges removed from the game
    }
    */
...
// REMOVED: Action Challenge Dialog (no longer part of the game)
// Action challenges have been completely removed from the game