...
List<String> getPlayerBadHabits(String player, String category) {
  ...
  QuizQuestion(
    question: 'What is the benefit of social connection?',
  ...
  QuizQuestion(
    question: 'How does gratitude practice help?',
  ...
  QuizQuestion(
    question: 'How long should deep breathing last?',
  ...
  QuizQuestion(
    ...
    options: ['Makes you lazy', 'Improves resilience', 'Causes weakness', 'Reduces goals'],
    correctIndex: 1,
    explanation: 'Self-compassion helps you bounce back from setbacks and maintain mental well-being.',
  ),
],
...
void onLadderQuizFailed(String player, Function(String, String) onNotify) {
  ...
  // ✅ FIX: Small delay before switching turn
